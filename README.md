...
<img width="644" height="658" alt="image" src="https://github.com/user-attachments/assets/73c0abc3-fd55-48d3-a018-147792550a4a" /> 
...
- Build the workspace
- Open 4 terminals and source each one and run the following 
